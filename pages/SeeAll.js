import ProductCard from "@/components/recommended/ProductCard"; // Adjust path if needed
...
export default function SeeAllPage() {
  ...
  return (
    <section className="bg-gray-50 pb-4 mt-5">
      {/* Full-Width Header */}
      <div className="bg-[#0ca838] w-full">
        <div className="max-w-7xl mx-auto px-4 flex items-center justify-between py-4">
          <h2 className="text-2xl font-bold text-gray-900">All Anniversary Deals</h2>
        </div>
      </div>
